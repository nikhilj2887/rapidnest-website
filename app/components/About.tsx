      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-300 mb-8 md:mb-10 leading-relaxed">
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <div
                    ...
                    "
                  >
                    <Icon className="w-6 h-6 md:w-8 md:h-8 text-orange-500 mx-auto mb-2 md:mb-3" />
            ...
            >
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-orange-500 to-amber-500 rounded-lg flex items-center justify-center text-white font-bold flex-shrink-0">
                    1
                  </div>
                ...
                {/* Step 2 */}
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-amber-500 to-orange-600 rounded-lg flex items-center justify-center text-white font-bold flex-shrink-0">
                    2
                  </div>
                ...
                {/* Step 3 */}
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-orange-600 to-red-600 rounded-lg flex items-center justify-center text-white font-bold flex-shrink-0">
                    3
                  </div>
