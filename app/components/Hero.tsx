...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-gray-950">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-500/10 to-cyan-500/10 border border-orange-500/20 mb-8"
        >
        ...
        >
          We build websites, apps, and custom software that help businesses launch faster and scale smarter.
        </motion.p>
        ...
        >
          <button
            ...
            className="group px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-600 text-white rounded-lg font-semibold text-lg hover:scale-105 transition-all duration-300"
          >
            Get Free Quote
          ...
          <button
            ...
            className="px-8 py-4 bg-white/10 border border-white/20 text-white rounded-lg font-semibold text-lg hover:bg-white/20 transition"
          >
            View Services
          </button>
        </motion.div>
